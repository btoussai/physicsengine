...
/**
 * Permet d'int�grer le terme gyroscopique (W x Ib * W) dans l'�quation
 * diff�rentielle portant sur la rotation d'un objet.
 * 
 * @author Briac
 *
 */
public class GyroscopicIntegrator {
	...
	/**
	 * Effectue une it�ration de la m�thode de Newton pour r�soudre l'�quation
	 * diff�rentielle sur la rotation, incluant le terme gyroscopique.
	 * 
	 * @param timeStep
	 * @param body
	 */
	 ...
	 * @param rotation La rotation du rep�re barycentrique.
