 ...
 *
 */
public class DoubleBodyContactBlockSolver extends AbstractDoubleBodyContact {
	...
	public DoubleBodyContactBlockSolver(int maxContacts, Wrapper wrapperA, Wrapper wrapperB) {
	...
	public void velocityStart() {
		...
		float inv_ma = bodyA.getInvMass();
		float inv_mb = bodyB.getInvMass();
		...
		if (matrix.size == Size.M1x1) {
			...
			float m00 = inv_mass_N[0];
			float m10 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[1], IA_inv, RaxN[0]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[1], IB_inv, RbxN[0]));
			...
			float m10 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[1], IA_inv, RaxN[0]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[1], IB_inv, RbxN[0]));
			float m11 = inv_mass_N[1];
			float m20 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[2], IA_inv, RaxN[0]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[2], IB_inv, RbxN[0]));
			float m21 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[2], IA_inv, RaxN[1]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[2], IB_inv, RbxN[1]));
			...
			float m21 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[2], IA_inv, RaxN[1]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[2], IB_inv, RbxN[1]));
			float m22 = inv_mass_N[2];
			float m30 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[3], IA_inv, RaxN[0]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[3], IB_inv, RbxN[0]));
			float m31 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[3], IA_inv, RaxN[1]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[3], IB_inv, RbxN[1]));
			float m32 = inv_ma * (1.0f + MatrixOps.sandwichDotProduct(RaxN[3], IA_inv, RaxN[2]))
					+ inv_mb * (1.0f + MatrixOps.sandwichDotProduct(RbxN[3], IB_inv, RbxN[2]));
