 ...
 *
 */
public class SingleBodyContactArrayBased extends AbstractSingleBodyContact {
	...
	public SingleBodyContactArrayBased(int maxContacts, Wrapper wrapper, Triangle triangle) {
