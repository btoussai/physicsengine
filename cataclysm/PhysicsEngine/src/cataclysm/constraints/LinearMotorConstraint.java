 ...
 * Cette barre peut tourner, on peut s'en servir pour mod�liser un treuil.
 * 
 * @see PistonConstraint <br>
 *      pour mod�liser un piston d'axe fixe.
 * @author Briac
 *
 */
public class LinearMotorConstraint extends LinearConstraint {
	...
	/**
	 * D�finit le comportement du piston.
	 * 
	 * @author Briac
	 *
	 */
	public enum MotionMode {
		/**
		 * Le piston essaie de s'�tendre et de se r�tracter pour atteindre une longueur
		 * sp�cifi�e par {@link LinearMotorConstraint#setTargetLength(float)}. <br>
		 * Sa vitesse est �gale �
		...
		/**
		 * Le piston essaie de modifier sa longueur � la vitesse sp�cifi�e par
	...
	/**
	 * La vitesse souhait�e d'extension du piston
	 */
	...
	/**
	 * La longueur souhait�e du piston.
	 */
	private float targetLength;

	/**
	 * La vitesse � laquelle le piston cherche � modifier sa longueur pour atteindre
	 * la longueur voulue. Plus pr�cis�ment:
	 * {@code targetSpeed = gain * (targetLength - currentLength)}
	 */
	 ...
	 * longueur du piston ne doit pas �tre nulle sinon le piston ne peut pas
	 * d�terminer une direction d'extension.
	 * 
	 * @param pointA
	 * @param pointB
	...
	/**
	 * @return La vitesse � laquelle le piston cherche � modifier sa longueur pour
	 *         atteindre la longueur voulue. Plus pr�cis�ment:
	 *         {@code targetSpeed = gain * (targetLength - currentLength)}
	 */
	...
	/**
	 * Modifie la vitesse � laquelle le piston cherche � modifier sa longueur pour
	 * atteindre la longueur voulue. Plus pr�cis�ment:
