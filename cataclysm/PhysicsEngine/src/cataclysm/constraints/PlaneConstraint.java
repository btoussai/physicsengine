...
/**
 * Cette contrainte restreint la position relative des solides � un plan. Ce
 * plan est d�fini dans le rep�re local (model-space) du solide de r�f�rence.
 * 
 * @author Briac
 *
 */
public class PlaneConstraint extends LinearConstraint {
	...
	/**
	 * Calcule le projet� orthogonal de point sur le plan d�fini par base et normal.
	 * Le r�sultat est stock� dans dest.
	 * 
	 * @param base
	 * @param normal
	 * @param point
	 * @param dest
	 * @return La distance sign�e entre point et le plan.
	 */
